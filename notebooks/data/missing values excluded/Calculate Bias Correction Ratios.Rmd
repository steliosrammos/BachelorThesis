...
# SKLearn model
data = pd.read_csv("/Users/steliosrammos/Documents/Education/Maastricht/DKE-Year3/BachelorThesis/bachelor_thesis/data/processed/classifier_s/data_classifier_s.csv", sep=";")
model_path = '/Users/steliosrammos/Documents/Education/Maastricht/DKE-Year3/BachelorThesis/bachelor_thesis/models/classifier_s/calibrated/classifier_s_sk_xgboost.sav'
classifier_s = joblib.load(model_path)
...
corr_coeff_sk_xgboost = pd.Series(corr_coeff_sk)
```

```{python}
# Import data
data = pd.read_csv("/Users/steliosrammos/Documents/Education/Maastricht/DKE-Year3/BachelorThesis/bachelor_thesis/data/processed/classifier_y/data_classifier_y.csv",sep=";")
data.insert(data.shape[1]-1, "weights", corr_coeff_sk_xgboost)

data.to_csv("/Users/steliosrammos/Documents/Education/Maastricht/DKE-Year3/BachelorThesis/bachelor_thesis/data/processed/classifier_y/weighted/sk_xgb_weights/data_classifier_y_weighted_sk_xgboost.csv", sep=";", index=False)
```
...
# H2O Model
data = h2o.import_file("/Users/steliosrammos/Documents/Education/Maastricht/DKE-Year3/BachelorThesis/bachelor_thesis/data/processed/classifier_s/data_classifier_s.csv")
model_path = "/Users/steliosrammos/Documents/Education/Maastricht/DKE-Year3/BachelorThesis/bachelor_thesis/models/classifier_s/uncalibrated/classifier_s_h2o/Grid_DRF_py_3_sid_b093_model_python_1553073290449_154565_model_6"
classifier_s = h2o.load_model(model_path)
s = data['got_go'].as_data_frame()
...
corr_coeff_h2o_uncalib = np.zeros(data.shape[0])

for i in range(0, prob_predicted_s.shape[0]):
            corr_coeff_h2o_uncalib[i] = prob_s / prob_predicted_s[i]
        
corr_coeff_h2o_uncalib = pd.Series(corr_coeff_h2o_uncalib)
```

```{python}
# Import data
data = pd.read_csv("/Users/steliosrammos/Documents/Education/Maastricht/DKE-Year3/BachelorThesis/bachelor_thesis/data/processed/classifier_y/data_classifier_y.csv",sep=";")
data.insert(data.shape[1]-1, 'weights', corr_coeff_h2o_uncalib)

data.to_csv("/Users/steliosrammos/Documents/Education/Maastricht/DKE-Year3/BachelorThesis/bachelor_thesis/data/processed/classifier_y/weighted/data_classifier_y_weighted_h2o_uncalib.csv", sep=";", index=False)
```
