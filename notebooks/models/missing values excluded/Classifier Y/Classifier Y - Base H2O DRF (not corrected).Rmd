...
```{python}
# data = h2o.import_file("/Users/steliosrammos/Documents/Education/Maastricht/DKE-Year3/BachelorThesis/bachelor_thesis/data/processed/classifier_y/data_classifier_y_lbld.csv")
train_data = h2o.import_file("/Users/steliosrammos/Documents/Education/Maastricht/DKE-Year3/BachelorThesis/bachelor_thesis/data/processed/classifier_y/unweighted/classifier_y_unweighted_train.csv")
test_data = h2o.import_file("/Users/steliosrammos/Documents/Education/Maastricht/DKE-Year3/BachelorThesis/bachelor_thesis/data/processed/classifier_y/unweighted/classifier_y_unweighted_test.csv")
...
```{python}
estimator = H2ORandomForestEstimator(nfolds=10, stopping_rounds=1000, seed=55)
```
...
```{python}
model_path = h2o.save_model(model=best_drf, path="/Users/steliosrammos/Documents/Education/Maastricht/DKE-Year3/BachelorThesis/bachelor_thesis/models/uncorrected_classifiers_y", force=True)
```
