...
```{python}
data_sk = h2o.import_file("/Users/steliosrammos/Documents/Education/Maastricht/DKE-Year3/BachelorThesis/bachelor_thesis/data/processed/classifier_y/weighted/sk_rf_weights/data_classifier_y_lbld_weighted_sk.csv")
...
for category in categorical:
    train_sk[category] = train_sk[category].asfactor()
...
train_sk, valid_sk = train_data.split_frame([0.8], seed=55)
```
...
```{python}
estimator = H2ORandomForestEstimator(weights_column="weights", nfolds=5, stopping_rounds=10, seed=55)
```
