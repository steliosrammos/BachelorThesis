...
# Classifier Y - SK XGBoost (uncorrected)
...
train_data = pd.read_csv('/Users/steliosrammos/Documents/Education/Maastricht/DKE-Year3/BachelorThesis/bachelor_thesis/data/processed/classifier_y/unweighted/classifier_y_unweighted_train.csv', sep=";")
test_data = pd.read_csv('/Users/steliosrammos/Documents/Education/Maastricht/DKE-Year3/BachelorThesis/bachelor_thesis/data/processed/classifier_y/unweighted/classifier_y_unweighted_test.csv', sep=";")
```
...
# Predicting
predicted = xgbest.predict_proba(test_data.iloc[:, :-1])
```

```{python}
get_metrics(test_data.iloc[:,-1], proba_predicted_y=predicted[:, 1])
print('Average precision-recall score: {0:0.2f}'.format(average_precision_score(test_data.iloc[:,-1], predicted[:, 1])))
```
...
print('Average precision-recall score: {0:0.2f}'.format(average_precision_score(test_data.iloc[:,-1], predicted_best[:, 1])))
```
