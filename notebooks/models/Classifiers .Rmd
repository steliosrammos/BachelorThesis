...
# sys.path.insert(0, '/Users/steliosrammos/Documents/Education/Maastricht/DKE-Year3/BachelorThesis/bachelor_thesis/src/models')

from src.models.VennABERS import ScoresToMultiProbs

# Turn off autosave for cleaner version control with jupytext
# %autosave 0
```
...
def import_data(format=None):
    data = pd.read_csv('/Users/steliosrammos/Documents/Education/Maastricht/DKE-Year3/BachelorThesis/bachelor_thesis/data/processed/data_2018.csv', sep=';')
    # data.head()
